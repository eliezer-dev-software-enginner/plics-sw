...
public class AddOrEditComprasAPagar implements ScreenComponent {
    Long id;
    ProdutoScreenViewModel viewModel;
    Logger log = LoggerFactory.getLogger(AddOrEditComprasAPagar.class);
    ...
    public AddOrEditComprasAPagar(ScreenContext screenContext) {

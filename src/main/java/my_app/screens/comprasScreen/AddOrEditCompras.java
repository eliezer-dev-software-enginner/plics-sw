...
public class AddOrEditCompras implements ScreenComponent {
    Long id;
    ProdutoScreenViewModel viewModel;
    Logger log = LoggerFactory.getLogger(AddOrEditCompras.class);
    ...
    public AddOrEditCompras(ScreenContext screenContext) {

...
public class AddOrEditContasAReceber implements ScreenComponent {
    Long id;
    ProdutoScreenViewModel viewModel;
    Logger log = LoggerFactory.getLogger(AddOrEditContasAReceber.class);
    ...
    public AddOrEditContasAReceber(ScreenContext screenContext) {

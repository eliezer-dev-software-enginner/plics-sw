...
public class AddOrEditOrdemServico implements ScreenComponent {
    Long id;
    ProdutoScreenViewModel viewModel;
    Logger log = LoggerFactory.getLogger(AddOrEditOrdemServico.class);
    ...
    public AddOrEditOrdemServico(ScreenContext screenContext) {

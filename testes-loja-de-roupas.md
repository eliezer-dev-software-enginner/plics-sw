...
| 49 | Venda a prazo (parcelado) | 15/06/2026 | Carla Lima | - | Vestido (SKU002) | 1 | R$ 89,90 | R$ 0 | A PRAZO | Sim | - | Gera 3 parcelas no Contas a Receber. | | Caused by: java.lang.ArrayIndexOutOfBoundsException: Index 0 out of bounds for length 0. Este erro foi causado após ter clicado no butão "Gerar parcelas" e então clicar para "Adicionar. Inclusive em quantidade eu havia esquecido de colocar um valor. |
